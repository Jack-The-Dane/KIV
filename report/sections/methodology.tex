...
\begin{figure}[H]
    ...
    \caption{Structure of the implemented CNN-LSTM. All parts in red boxes are non-configurable, while boxes of all other colors contain parameters that were varied in a grid search. The dropout parameter is kept the same in all layers, in the interest of reducing the number of configurations searched.}
    \label{fig:CNN-LSTM}
\end{figure}
